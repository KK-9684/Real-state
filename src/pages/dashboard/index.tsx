        ...
        <div className="py-5 px-20 text-center">
            <Table className="w-full" aria-label="Example table with dynamic content">
                <TableHeader>
                    ...
                    <TableColumn>Contract Price</TableColumn>
                    <TableColumn>Asking Price</TableColumn>
                    <TableColumn>Inspection Expiration</TableColumn>
                    <TableColumn>Closing Date</TableColumn>
                </TableHeader>
                <TableBody>
                    {kg.map((element) => (
                        <TableRow key={element} className="h-10 border-b-[1px]">
                            <TableCell>{element}</TableCell>
                            <TableCell><Image src="/logo-real.png" alt="featured" width={80} height={80} style={{ width: '80px', height: "auto" }}></Image></TableCell>
                            <TableCell>{}</TableCell>
                            <TableCell>{}</TableCell>
                            <TableCell>{}</TableCell>
                            <TableCell>{}</TableCell>
